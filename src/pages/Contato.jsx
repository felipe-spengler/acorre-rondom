            ...
            <section className="py-20 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* WhatsApp Card */}
                        <motion.a
                            href={`https://wa.me/55${getVal('contato_whatsapp').replace(/\D/g, '')}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            whileHover={{ y: -10 }}
                            className="glass p-10 rounded-3xl border border-white/10 flex flex-col items-center text-center group"
                        >
                            <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mb-8 border border-primary/20 group-hover:bg-primary group-hover:text-black transition-all duration-500 shadow-[0_0_30px_rgba(57,255,20,0.1)]">
                                <Phone size={32} />
                            </div>
                            <h3 className="text-2xl font-black uppercase tracking-widest mb-4 italic">WhatsApp</h3>
                            <p className="text-gray-400 mb-6 font-medium">{getVal('contato_whatsapp')}</p>
                        ...
                        >
                            ...
                            <p className="text-gray-400 mb-6 font-medium">{getVal('social_instagram_handle')}</p>
                            <span className="text-primary font-bold flex items-center gap-2 group-hover:gap-4 transition-all">
                        ...
                        >
                            ...
                            <p className="text-gray-400 mb-6 font-medium">{getVal('contato_email')}</p>
                    ...
                    >
                        <div className="flex items-center gap-6">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-lg font-bold">{getVal('contato_endereco')}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center border border-white/10">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-lg font-bold">{getVal('contato_treinos_info')}</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
