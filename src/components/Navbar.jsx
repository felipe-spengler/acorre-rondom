                ...
                <div className="flex justify-between items-center">
                    <Link to="/" className="flex items-center space-x-3 group">
                        <motion.div
                            ...
                            className="w-10 h-10 rounded-lg overflow-hidden border border-primary transition-transform shadow-[0_0_15px_rgba(57,255,20,0.3)] group-hover:shadow-[0_0_25px_rgba(57,255,20,0.6)]"
                        >
